 ...
 * @constructor
 */
// window['P8'] = function(sfx, music) {
function P8(sfx, music) {
   ...
   */
  const playAudioBuffer = (audioBuffer, loop = false, loopStart = 0, vol = 0.2) => {
   ...
   * @return {!AudioBufferSourceNode}
   */
  const playMusic = (vol = 0.2, startPattern = 0) => {
    // Preprocess loop
    ...
    return playAudioBuffer(audioBuffer, true, loopStart, vol);
  };
